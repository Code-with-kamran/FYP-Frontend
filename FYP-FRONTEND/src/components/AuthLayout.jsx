...
const AuthLayout = ({ children, title, subtitle }) => {
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Branding */}
      {/* ADDED: sticky top-0 h-screen to fix it in place */}
      <div className="hidden lg:flex lg:w-2/5 bg-primary  overflow-hidden sticky top-0 h-screen">
        ...
        {/* Content Container - already has justify-center for vertical alignment */}
      ...
      {/* Right Side - Form */}
      {/* Needs min-h-screen to ensure full height, but allows scrolling */}
      <div className="w-full lg:w-3/5 flex items-center justify-center p-6 bg-gray-50 min-h-screen">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="mb-6">
              <h2 className="text-3xl  text-gray-800 mb-2">{title}</h2>
